...
/*   Updated: 2020/05/28 18:05:09 by mkarkaus         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_float_integer(struct s_flag *f, long double *nbr, int *i)
{
	long double	tens;
	long double	calc;
...
void	ft_find_size(struct s_flag *f, long double nb)
{
	while ((long)(nb /= 10) != 0)
		(*f->num)++;
}
